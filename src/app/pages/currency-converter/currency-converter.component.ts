...
export class CurrencyConverterComponent implements OnInit {
  readonly converterActions: FeatureActionItem[] = [
    { label: '匯率歷史', icon: 'timeline', routerLink: '/currency-converter/history', tone: 'accent' },
    { label: '匯率工作台', icon: 'tune', routerLink: '/currency-converter/workspace' }
  ];

  get converterHighlights(): InfoPillItem[] {
    return [
      { label: '來源貨幣', value: this.baseCurrency, icon: 'south_west', tone: 'accent' },
      { label: '目標貨幣', value: this.targetCurrency, icon: 'north_east', tone: 'success' },
      { label: '更新方式', value: this.loading ? '匯率更新中' : '使用 mock rates', icon: 'sync', tone: 'warning' }
    ];
  }
