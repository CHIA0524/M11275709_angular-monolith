...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, FormsModule, ReactiveFormsModule, RouterModule, MatButtonModule, MatCardModule, MatFormFieldModule, MatInputModule, MatSelectModule, MatSlideToggleModule, TranslatePipe],
...
export class SettingsWorkspaceComponent implements AfterViewInit, OnDestroy {
  ...
  readonly defaultColorPreset = this.settingsService.getDefaultColorPreset();
  ...
  applyDefaultPalette(): void {
    this.applyPreset(this.defaultColorPreset);
  }
