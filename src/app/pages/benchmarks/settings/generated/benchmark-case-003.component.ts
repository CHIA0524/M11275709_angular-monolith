...
export class BenchmarkCase003Component {
  readonly pageTitle = 'Settings Monolith Benchmark Case 003';
  readonly pageCode = 'SETTINGS-MONOLITH-003';
  ...
  readonly narrative = Array.from({ length: 18 }, (_, index) => ({
    ...
    body: 'Synthetic benchmark content for Settings Monolith case 003 section ' + String(index + 1).padStart(2, '0') + '. This content exists to stress template parsing, chunk generation, and style extraction during Angular builds.'
  }));
