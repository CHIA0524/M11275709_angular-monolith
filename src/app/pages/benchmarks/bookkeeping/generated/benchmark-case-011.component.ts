...
export class BenchmarkCase011Component {
  readonly pageTitle = 'Bookkeeping Monolith Benchmark Case 011';
  readonly pageCode = 'BOOKKEEPING-MONOLITH-011';
  ...
  readonly narrative = Array.from({ length: 18 }, (_, index) => ({
    ...
    body: 'Synthetic benchmark content for Bookkeeping Monolith case 011 section ' + String(index + 1).padStart(2, '0') + '. This content exists to stress template parsing, chunk generation, and style extraction during Angular builds.'
  }));
