...
export class BenchmarkCase005Component {
  readonly pageTitle = 'Dashboard Monolith Benchmark Case 005';
  readonly pageCode = 'DASHBOARD-MONOLITH-005';
  ...
  readonly narrative = Array.from({ length: 18 }, (_, index) => ({
    ...
    body: 'Synthetic benchmark content for Dashboard Monolith case 005 section ' + String(index + 1).padStart(2, '0') + '. This content exists to stress template parsing, chunk generation, and style extraction during Angular builds.'
  }));
