...
export class BenchmarkCase015Component {
  readonly pageTitle = 'Dashboard Monolith Benchmark Case 015';
  readonly pageCode = 'DASHBOARD-MONOLITH-015';
  ...
  readonly narrative = Array.from({ length: 18 }, (_, index) => ({
    ...
    body: 'Synthetic benchmark content for Dashboard Monolith case 015 section ' + String(index + 1).padStart(2, '0') + '. This content exists to stress template parsing, chunk generation, and style extraction during Angular builds.'
  }));
