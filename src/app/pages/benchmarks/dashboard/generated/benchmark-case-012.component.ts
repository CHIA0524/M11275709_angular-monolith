...
export class BenchmarkCase012Component {
  readonly pageTitle = 'Dashboard Monolith Benchmark Case 012';
  readonly pageCode = 'DASHBOARD-MONOLITH-012';
  ...
  readonly narrative = Array.from({ length: 18 }, (_, index) => ({
    ...
    body: 'Synthetic benchmark content for Dashboard Monolith case 012 section ' + String(index + 1).padStart(2, '0') + '. This content exists to stress template parsing, chunk generation, and style extraction during Angular builds.'
  }));
