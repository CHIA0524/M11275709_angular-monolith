...
export class BenchmarkCase006Component {
  readonly pageTitle = 'Dashboard Monolith Benchmark Case 006';
  readonly pageCode = 'DASHBOARD-MONOLITH-006';
  ...
  readonly narrative = Array.from({ length: 18 }, (_, index) => ({
    ...
    body: 'Synthetic benchmark content for Dashboard Monolith case 006 section ' + String(index + 1).padStart(2, '0') + '. This content exists to stress template parsing, chunk generation, and style extraction during Angular builds.'
  }));
