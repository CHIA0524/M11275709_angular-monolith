...
export class BenchmarkCase008Component {
  readonly pageTitle = 'Currency Converter Monolith Benchmark Case 008';
  readonly pageCode = 'CURRENCY-CONVERTER-MONOLITH-008';
  ...
  readonly narrative = Array.from({ length: 18 }, (_, index) => ({
    ...
    body: 'Synthetic benchmark content for Currency Converter Monolith case 008 section ' + String(index + 1).padStart(2, '0') + '. This content exists to stress template parsing, chunk generation, and style extraction during Angular builds.'
  }));
