...
export class BenchmarkCase012Component {
  readonly pageTitle = 'Currency Converter Monolith Benchmark Case 012';
  readonly pageCode = 'CURRENCY-CONVERTER-MONOLITH-012';
  ...
  readonly narrative = Array.from({ length: 18 }, (_, index) => ({
    ...
    body: 'Synthetic benchmark content for Currency Converter Monolith case 012 section ' + String(index + 1).padStart(2, '0') + '. This content exists to stress template parsing, chunk generation, and style extraction during Angular builds.'
  }));
